...
#---------------------------------------------------------------------------------
LIBS := -O2 -lm -lctru -lcitro2d -lcitro3d `curl-config --libs`
...
APP_TITLE         := SmileBASIC Download Station
APP_DESCRIPTION   := SmileBASIC Download Station: Demo version
APP_AUTHOR        := the_squat1115, CyberYoshi64
